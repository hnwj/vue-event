  ...
  <div>
    <el-card class="box-card">
      ...
      <div class="search-box">
        ...
        <!-- 发表文章的按钮 -->
        <el-button type="primary" size="small" class="btn-pub" @click="showPubDialogFn">发表文章
        </el-button>
      </div>
...
import { getCateListAPI, uploadArticleAPI, getArticleListAPI, getArticleDetailAPI } from '@/api'
export default {
  name: 'ArtList',
  data () {
    return {
